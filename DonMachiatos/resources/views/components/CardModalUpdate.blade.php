<div x-show="showCardUpdateModal === true" 
    x-cloak
    x-init="$watch('showCardUpdateModal', value => { if(value) { quantity = 1; currentPrice = selectedProduct?.price || 0; } })"
    class="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-xs bg-white/5"
    @click.self="showCardUpdateModal = false">
